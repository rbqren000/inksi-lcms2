...
cp liblcms2.a "$SCRIPT_DIR/liblcms2-ohos-arm64-v8a.a"
echo "Done: $SCRIPT_DIR/liblcms2-ohos-arm64-v8a.a ($(du -h "$SCRIPT_DIR/liblcms2-ohos-arm64-v8a.a" | cut -f1))"
